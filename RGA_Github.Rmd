...
* developers.google.com/analytics/solutions/r-google-analytics

* developers.google.com/identity/sign-in/web/devconsole-project

* cran.r-project.org/web/packages/RGA/vignettes/common-queries.html

* cran.r-project.org/web/packages/RGA/vignettes/authorize.html
